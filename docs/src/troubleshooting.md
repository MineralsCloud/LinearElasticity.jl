...
[discuss with us](https://github.com/MineralsCloud/LinearElasticity.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/LinearElasticity.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/LinearElasticity.jl/compare) with suggestions.
